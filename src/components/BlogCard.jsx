  ...
  return (
    <article className="relative bg-white border border-gray-100 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-transform duration-300 hover:-translate-y-1">
      ...
      <div className="flex h-full flex-col gap-4 md:flex-row">
        ...
        <div className="flex md:w-1/2 flex-col p-5">
          ...
          <button className="mt-auto self-end inline-flex items-center rounded-md bg-orange-500 px-4 py-2 text-white text-base font-semibold hover:bg-orange-600 transition">
            Read More
          </button>
        </div>
      </div>
